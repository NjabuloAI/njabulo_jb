...
fana({ nomCom: "menu-mod", categorie: "General" }, async (dest, zk, commandeOptions) => {
    ...
    let infoMsg = `
┏──────────────⊷
┊✏︎ʙᴏᴛ ɴᴀᴍᴇ :  *ɴᴊᴀʙᴜʟᴏ ᴊʙ*
┗──────────────⊷
┏ 
*【Mods】⇳︎*
- .①date                     ⬄︎ _<text>_
- .②calculate             ⬄︎ _<text>_
- .③hack                    ⬄︎ _@use_
- .④block                   ⬄︎ _@use_
- .⑤unblock               ⬄︎ _@use_
- .⑥trt                         ⬄︎ _<reply text>_
- .⑦left                       ⬄︎ _<@use_
- .⑧time                     ⬄︎ _<text>_
- .⑨leave                    ⬄︎ _<@use>_
- .⑩deep                     ⬄︎ _<reply audio>_
- .⑪bass                     ⬄︎ _<reply audio>_
- .⑫reverse                 ⬄︎ _<reply audio>_
- .⑬slow                     ⬄︎ _<reply audio>_
- .⑭smooth                ⬄︎ _<reply audio>_
- .⑮tempo                  ⬄︎ _<reply audio>_
- .⑯nightcore             ⬄︎ _<reply audio>_      
 ┗
> ✆︎Pσɯҽɾҽԃ Ⴆყ NנɐႦυℓσ נႦ
┏──────────────⊷
┊⌛︎ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅᴇs mode
┊☪︎ : ${greeting}
┗──────────────⊷ `;
    ...
    try {
        if (mediaUrl.match(/\.(mp4|gif)$/i)) {
            await zk.sendMessage(dest, {
                ...
                contextInfo: {
                    externalAdReply: {
                        title: "⌛︎Menu mod status",
                        body: "✆︎Pσɯҽɾҽԃ Ⴆყ NנɐႦυℓσ נႦ",
                        mediaType: 1,
