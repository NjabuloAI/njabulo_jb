...
fana({
  ...
  switch (option) {
    case "yes":
      ...
      responseMessage = '*Pᥙbᥣιᥴ modᥱ hᥲs bᥱᥱn ᥱnᥲbᥣᥱd sᥙᥴᥴᥱssfᥙᥣᥣყ*';
      break;

    case "no":
      s.MODE = 'no';  // Disable public mode
      responseMessage = '*Pᥙbᥣιᥴ modᥱ hᥲs bᥱᥱn dιsᥲbᥣᥱd sᥙᥴᥴᥱssfᥙᥣᥣყ*';
      break;

    default:
      return sendFormattedMessage(zk, chatId, "Please don't invent an option. Type 'publicmode yes' or 'publicmode no'.", ms);
  }
